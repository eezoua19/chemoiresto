  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative rounded-xl p-2.5 text-ink-500 transition hover:bg-ink-100 hover:text-ink-800"
      ...
      {open && (
        <div className="absolute right-0 z-40 mt-2 w-[320px] animate-slide-up overflow-hidden rounded-2xl border border-ink-100 bg-white shadow-float sm:w-[380px]">
          ...
          <div className="max-h-[60vh] overflow-y-auto">
            {notifications.length === 0 ? (
              <p className="px-4 py-10 text-center text-sm text-ink-500">Aucune notification</p>
            ) : (
              notifications.map((notification) => {
                ...
                return (
                  ...
                  >
                    <span className="mt-0.5 h-fit rounded-lg bg-ink-100 p-1.5 text-ink-600">
                      <Icon size={15} />
                    </span>
